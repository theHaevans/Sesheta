...
$requiredFields = "name,email,for-whom,storytype,comments";

$defaultText = "Care to share?";

$errorText = "We need a little more info.";

$successText = "Submission accepted.";
...
$multiFields = "for-whom,storytype";
